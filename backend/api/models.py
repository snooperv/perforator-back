...
class Profile(models.Model):
    ...
    manager = models.OneToOneField('self', on_delete=models.PROTECT, null=True)
    peers = models.ManyToManyField('self', null=True)
    team = models.ManyToManyField('self', null=True)
