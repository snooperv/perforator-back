    ...
    <div class="background">
        <div class="login">
            ...
            <div id="formContent">
                ...
                <form class="log">
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Номер телефона" required>
                ...
                <div id="formEnter">
                <p>У вас еще нет аккаунта? <a href="/register" style="color: #2C286D;">Зарегистрироваться</a></p>
                </div>
            </div>
        </div>
</div>
